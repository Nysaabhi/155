...
.jobs-container {
  display: flex;
  flex-direction: column;
  gap: 16px; /* This already adds space between items, but you can use margin-bottom as well */
  width: 100%;
  max-width: 600px;
}
...
.job-item {
  ...
  transition: transform 0.2s ease, box-shadow 0.2s ease;
  border: 1px solid rgba(255, 255, 255, 0.1);
  margin-bottom: 16px; /* Add this line to create space between job items */
}
